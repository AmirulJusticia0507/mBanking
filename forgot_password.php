...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT usersid, username, fullname FROM users_new WHERE username = ? OR fullname = ?";
...
<head>
    ...
    <title>Forgot Password E-Visit BPRS HIK MCI</title>
...
<body>
    <div class="content">
        ...
        <div class="text">Forgot Password <span style="color:green">E-Visit</span></div>
