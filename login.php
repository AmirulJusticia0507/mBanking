...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT userid, username, password, fullname FROM db_bmt_beningsuci.users WHERE username = ? OR fullname = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            $updateQuery = "UPDATE db_bmt_beningsuci.users SET login_date = ? WHERE userid = ?";
