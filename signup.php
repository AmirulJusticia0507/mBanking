...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO db_bmt_beningsuci.users (Username, PASSWORD, FullName, created_at, role) VALUES (?, ?, ?, ?, ?)";
    ...
    <div class="content">
        ...
        <form action="#" method="post" onsubmit="return validateForm()">
            ...
            <div class="field">
                ...
                <select name="role" id="role" style="width: 100%;" class="form-select" required>
